...
export default class ImmunizationSchedule extends React.Component {
  ...
  render() {
    ...
    const page = "ImmunizationSchedule";
    ...
    return (
      <View style={styles.background}>
        ...
        <WebView
          ...
          source={{
            uri: "https://www.dothanpediatricclinic.com/immunization-schedule",
          }}
