...
export default class DothanPedContactForLocations extends React.Component {
  ...
  render() {
    ...
    const page = "DothanPedContactForLocations";
    ...
    return (
      <View style={styles.background}>
        ...
        <WebView
          ...
          source={{
            uri: "https://www.dothanpediatricclinic.com/contact-us",
          }}
