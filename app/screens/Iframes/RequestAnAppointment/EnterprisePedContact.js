...
export default class EnterprisePedContact extends React.Component {
  ...
  render() {
    ...
    const page = "EnterprisePedContact";
    ...
    return (
      <View style={styles.background}>
        <Header backFunc={() =>
          navigate("RequestAnAppointment", {
            name: "RequestAnAppointment",
          })}/>
        <WebView
          onLoad={() => this.hideSpinner()}
          source={{
            uri: "https://www.enterprisepediatricclinic.com/contact",
          }}
