            ...
            <View style={styles.middleBackgroundBottom}>
              ...
              <View style={styles.verticalMenu}>
                <Text
                  ...
                  onPress={() => handleNav("DothanPedContact")}
                >
                  DOTHAN
                </Text>
              </View>
              <View style={styles.verticalMenu}>
                <Text
                  style={styles.bodyText}
                  onPress={() => handleNav("DothanSubContact")}
                >
                  DOTHAN SUBSPECIALTY
                </Text>
              </View>
              <View style={styles.verticalMenu}>
                <Text
                  style={styles.bodyText}
                  onPress={() => handleNav("EnterprisePedContact")}
                >
                  ENTERPRISE
                </Text>
              </View>
              <View style={styles.verticalMenu}>
                <Text
                  style={styles.bodyText}
                  onPress={() => handleNav("EufaulaPedContact")}
                >
                  EUFAULA
                </Text>
              </View>
              <View style={styles.verticalMenu}>
                <Text
                  style={styles.bodyText}
                  onPress={() => handleNav("OzarkPedContact")}
                >
                  OZARK
                </Text>
              </View>
