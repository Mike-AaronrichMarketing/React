          ...
          <ScrollView>
            ...
            <View style={styles.middleBackgroundBottom}>
              ...
              <View style={styles.verticalMenu}>
                <Text
                  style={styles.bodyText}
                  onPress={() => handleNav("DothanSubApp")}
                >
                  DOTHAN SUBSPECIALTY
                </Text>
              </View>
              <View style={styles.verticalMenu}>
                <Text
                  style={styles.bodyText}
                  onPress={() => handleNav("EnterpriseApp")}
                >
                  ENTERPRISE
                </Text>
              </View>
